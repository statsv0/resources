const info=[{ref:"PG",description:"Previous group"},{ref:"BR",description:"Best ranking"},{ref:"BRR",description:"Best ranking rounds"},{ref:"AGE",description:""},{ref:"TR",description:"Total rounds"},{ref:"TW",description:"Total wins"},{ref:"TL",description:"Total loses"},{ref:"TNP",description:"Total not played"},{ref:"W2S",description:"Wins in 2 sets"},{ref:"W3S",description:"Wins in 3 sets"},{ref:"L2S",description:"Losses in 2 sets"},{ref:"L3S",description:"Losses in 3 sets"},{ref:"TT",description:"Total tie breaks"},{ref:"TTW",description:"Total tie break wins"},{ref:"TTL",description:"Total tie break losses"}];function minifyHTML(a,...b){var c=[];c.push(a[0]);for(var d=1;d<a.length;d++)c.push(a[d],String(arguments[d]));return c.join("")}class StatsTemplate extends HTMLElement{constructor(){super();const{title:a,source:b,date:c}=this.attributes;this.title=a.value;this.source=b.value;this.date=c.value}connectedCallback(){this.innerHTML=`
        <div class="header-container">
            ...
            <h3>${this.title}</h3>
            <div>${info.map(a=>{return a.description?`<span><b>${a.ref}</b> = ${a.description}</span> `:""}).join("")}
            </div>
            <br>
